...
// for sound bg
  $('.tado-sound-btn').on('click',function(){
        ...
        if($('.kenburns-wrap').length){
            $('.kenburns-wrap').each(function () {
              ...
              $(this).find('.kenburns-play').css('bottom', bottomplay + 'px');
                $(this).find('.tado-sound-btn').css('bottom', bottomplay + 'px');
                $(this).find('.but-eye-wrap').css('bottom', bottomplay + 40 + 'px');

                $(this).css('height', sliderH + 'px');

                if($(window).width() < 768 && _ismobile){
                    $(this).find('.tado-sound-btn').css('bottom', bottomplay - 50 + 'px');
    ...
    function playSound() {
        ...
        if ($('.tado-sound-btn').length && $('.tado-sound-btn').hasClass('play')) {
            $('.tado-sound-btn').next('audio').trigger('play');
        }
    }
