...
// Likes for blog
  ...
  function animation() {
    $('.vc_row').each(function(index, el) {
      $(this).find('.tg-item-inner, .banner-shop-main, .banner-shop-phone, .banner-shop-cart, .banner-blog-main, .banner-blog-phone').each(function(index, el) {
        var delay = 0;
        var effect = 'fade-up';
        var target = $(this);
        ...
        if ($(this).hasClass('tg-item-inner')) {
          effect = 'fade';
        }

        if ($(this).hasClass('banner-shop-main')) {
          effect = 'fade-left';
        }

        if ($(this).hasClass('banner-blog-main')) {
          effect = 'fade-right';
        }
        ...
        $(target).addClass('aos-animate').attr('data-aos', effect).attr('data-aos-delay', delay);
      });
    });
  }
